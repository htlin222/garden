...
Evaluate a peripheral blood smear using a systematic and thorough approach:

•   Examine the entire feathered edge first: Large things (e.g., platelet clumps, blasts) can sometimes end up on the feathered edge so look for these first so you don’t miss them. See Figure 7.3A.
