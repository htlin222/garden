...
* [Gleason score](220706-2210-gleason score.md) & grade group (histology): Gleason score determines Grade Group. 1 = best → 5 = worst. Group 1: 3+3=6 (most common histologic pattern is 1st #, next is 2nd #), Group 2: 3+4=7, Group 3: 4+3=7, Group 4: 4+4=8, Group 5: all higher.

## [Risk Stratification and Treatment of Localized Prostate Cancer](https://i.imgur.com/idEfQfK.png)
> [Risk Stratification andreatment of Localized Prostate](Risk-Stratification-andreatment-of-Localized-Prostate.md)
